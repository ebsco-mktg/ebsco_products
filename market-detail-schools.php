...
<body>
  ...
  <div id="ebscoSite" class="page_market market_schools">
    ...
    <section class="container container_market-hero">
        <div class="inner">
            <main role="main" aria-labelledby="ariaPageTitle" class="content size1of1 shift2of12 size8of12 shift2of14 size10of14 shift3of16 size10of16">
              <h1 id="ariaPageTitle">Schools</h1>
              <p>Supporting research that <em>transform lives</em></p>
            </main>
            <div class="content-hr content size1of1 shift3of9 size3of9 shift3of10 size4of10 shift4of12 size4of12 shift5of14 size4of14 shift6of16 size4of16">
              <hr />
            </div>
          </div>
      </section>

    <!-- ===== START container: Announcement ===== -->
      ...
      <div class="inner">
        <div class="content size1of1 size0of9 size4of9 shift1of10 size4of10 shift0of12 size4of12 shift1of16 size4of16">
          <div class="btn btn-hollow">
            <a href="#target" class="btn-target">High Schools</a>
          </div>
        </div>
        <div class="content size1of1 shift1of9 size4of9 shift0of10 size4of10 shift0of12 size4of12 shift1of16 size4of16">
          <div class="btn btn-hollow">
            <a href="#target" class="btn-target">Middle Schools</a>
          </div>
        </div>
        <div class="content size1of1 size0of9 size4of9 shift1of10 size4of10 shift0of12 size4of12 shift1of16 size4of16">
          <div class="btn btn-hollow">
            <a href="#target" class="btn-target">Elementary Schools</a>
          </div>
        </div>
        <div class="content size1of1 shift1of9 size4of9 shift0of10 size4of10 shift0of12 size4of12 shift1of16 size4of16">
          <div class="btn btn-hollow">
            <a href="#target" class="btn-target">Canada Schools</a>
          </div>
        </div>
        <div class="content size1of1 size0of9 size4of9 shift1of10 size4of10 shift0of12 size4of12 shift1of16 size4of16">
          <div class="btn btn-hollow">
            <a href="#target" class="btn-target">Australia &amp; New Zealand Schools</a>
          </div>
        </div>
        <div class="content size1of1 shift1of9 size4of9 shift0of10 size4of10 shift0of12 size4of12 shift1of16 size4of16">
          <div class="btn btn-hollow">
            <a href="#target" class="btn-target">UK &amp; Ireland Schools</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="container container_market-detail">
      <div class="inner">
        <div class="content size1of1 shift1of10 size8of10 shift2of12 size8of12 shift2of14 size10of14 shift3of16 size10of16">
          <h2>Browse Databases by Subject</h2>
        </div>
        <div class="content content-subject-list size1of1 shift1of10 size4of10 shift2of12 size4of12 shift2of14 size4of14 shift3of16 size4of16">
          <h3>Top Databases</h3>
          <ul>
            <li><a href="#">Academic Search Ultimate</a></li>
            <li><a href="#">Business Source Ultimate</a></li>
            <li><a href="#">Applied Science &amp; Technology Source Ultimate</a></li>
          </ul>
          <p class="btn btn-hollow">
            <a class="btn-target" href="#">See All Databases</a>
          </p>
        </div>
        <div class="content content-subject-list size1of1 shift1of10 size4of10 shift2of12 size4of12 shift2of14 size4of14 shift3of16 size4of16">
          <h3>Covering All Subjects</h3>
          <ul>
          ...
          <p class="btn btn-hollow">
            <a class="btn-target" href="#">See By Subject</a>
          </p>
        </div>
        <div class="content size1of1 shift1of10 size8of10 shift2of12 size8of12 shift2of14 size10of14 shift3of16 size10of16">
          <h2>A Unified Research Solution</h2>
          <p>EBSCO’s suite of academic products and services offers a fully integrated research solution that benefits both users and librarians. The combination of EBSCO’s discovery technology, industry-leading collection of full-text content and high-end subject indexes will not only improve the research experience for your users, but will also maximize your budget while increasing usage of your entire collection of library resources. We invest in partnerships and conduct extensive user research to create a customizable user experience that is tailored to the needs of students, faculty and alumni.</p>
        </div>
        <div class="content size1of1 shift1of10 size8of10 shift2of12 size8of12 shift2of14 size10of14 shift3of16 size10of16">
          <h2>Easily Accomplish Your Goals</h2>
          <p>EBSCO can help you accomplish your goals by increasing the exposure of your collection to students and faculty while minimizing your workflow. Our back-end resources are optimized to streamline library workflows and reduce redundancy in your collection of academic journals, academic databases, academic eBooks and other electronic resources, while automated uploading of content means you’ll spend less time behind the scenes.</p>
        </div>
        <div class="content size1of1 shift1of10 size8of10 shift2of12 size8of12 shift2of14 size10of14 shift3of16 size10of16">
          <h2>Recent News</h2>
          <ul>
            <li><a href="#">EBSCO, in Partnership with American Library Association, Awards Scholarships for Librarians to Attend 2017 Annual Conference</a></li>
            <li><a href="#">EBSCO Information Services Certified Under Privacy Shield Framework</a></li>
            <li><a href="#">Letting the Dogs In to Battle the Stress of Finals</a></li>
          </ul>
        </div>
      </div>
    </section>

    <section class="container container_customer-story">
      <div class="inner">
        <div class="image_header-icon icon-story content content-flush hide4 hide6 hide9 size1of10 shift1of12 size1of12 shift1of14 size1of14 shift2of16 size1of16">
          <?php include 'components/header-icon/header_icon.php'; ?>
        </div>
        <div class="content content-story size1of1 size8of10 size8of12 size10of14 size10of16">
          <h2>OhioLINK Success Story</h2>
          <p class="headline">Library impliments EBSCO Discovery Service to support users’ needs</p>
